  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        navy: {
          DEFAULT: "#1a1a1a", // Dark gray from the image
          light: "#2a2a2a", // Slightly lighter gray for contrast
          dark: "#121212", // Very dark gray for shadows
        },
        slate: {
          light: "#d0d0d0", // Light gray from the image
